...
String gvsFromDefault = CustomKeywords.'com.kazurayam.ks.globalvariable.ExpandoGlobalVariable.toJson'(true)
println "\n" + "gvsFromDefault: " + gvsFromDefault + "\n"

CustomKeywords.'com.kazurayam.ks.globalvariable.ExecutionProfilesLoader.loadProfile'('test_A')

String gvsPlus = CustomKeywords.'com.kazurayam.ks.globalvariable.ExpandoGlobalVariable.toJson'(true)
println "\n" + "gvsPlus: " + gvsPlus + "\n"
