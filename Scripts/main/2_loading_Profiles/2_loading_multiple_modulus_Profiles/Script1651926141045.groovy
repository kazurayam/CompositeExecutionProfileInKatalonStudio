...
List<String> gvInCategory1 = 
    CustomKeywords.'com.kazurayam.ks.globalvariable.ProfilesRetriever.listGlobalVariableInProfile'(".*", "main_category1")
gvInCategory1.stream().forEach({msg -> println msg})

List<String> gvInEnvDevelopment = 
    CustomKeywords.'com.kazurayam.ks.globalvariable.ProfilesRetriever.listGlobalVariableInProfile'(".*", "main_envDevelopment")
gvInEnvDevelopment.stream().forEach({msg -> println msg})

List<String> gvInIncludeSheets_CompanyB = 
    CustomKeywords.'com.kazurayam.ks.globalvariable.ProfilesRetriever.listGlobalVariableInProfile'(".*", "main_includeSheets_CompanyB")
