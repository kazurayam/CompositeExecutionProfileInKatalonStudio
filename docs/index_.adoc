...
[source, groovy]
----
include::../Scripts/main/1_listing/2_listProfiles/Script1651915776577.groovy[]
----
...
I want to list GlobalVariables filtered by its name with Regular Expression. If a name of GlobalVariable appear in 2 Profiles, want 2 lines of that GlobalVariable. 
